  ...
  return (
    <section className="relative bg-[#131313] flex items-center justify-center overflow-hidden py-[100px] pt-[164px] pb-[100px] md:pb-[100px] min-h-screen">
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(255,184,0,0.08) 0%, rgba(255,184,0,0) 70%)" }}
      />
      ...
      <div className="relative z-10 w-full max-w-[1280px] px-6">
        <div className="max-w-[896px] flex flex-col gap-[14px]">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-stretch md:items-center mt-[17px]">
            <a
              href="#projects"
